...
<table class="table table-bordered" id="table">
    <tr>
        <td colspan="13" style="text-align:center;">DAFTAR PERUBAHAN KARYAWAN</td>
    </tr>
    <tr>
        <% if tgla <> "" then %>
            <td colspan="13" style="text-align:center;"><b>PROIODE <%= Cdate(tgla) &"-"& Cdate(tgle) %></b></td>
        <% end if %>
        <% if tahun <> "" then %>
            <td colspan="13" style="text-align:center;"><b>PROIODE TAHUN<%= tahun %></b></td>
        <% end if %>
    </tr>
