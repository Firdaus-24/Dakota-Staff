...
<div class="btn-group position-absolute top-0 end-0" role="group" aria-label="Basic outlined example">
  <button type="button" class="btn btn-outline-primary btn-sm" onClick="window.open('exportXls-karyawanpromorsi.asp?urut=<%=urut%>&tgla=<%=tgla%>&tgle=<%=tgle%>','_self')">EXPORT</button>
</div>
<div class='row'>
