...
Response.AddHeader "content-disposition", "filename=Karyawan Rotasi "& Request.QueryString("tgla") &" sampai "& Request.QueryString("tgle") &".xls"
%>
            ...
            if bulan = 1 then
             ...
             %>
                <tr>
                    ...
                    <td><%=hasilstatus%></td>
                    <td style="mso-number-format:\@;"><%=mutasi("Kry_JmlAnak")%></td>
                </tr>
            <% 
            Response.flush
            mutasi.movenext
