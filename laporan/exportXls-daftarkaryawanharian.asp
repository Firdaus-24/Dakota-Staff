...
Response.AddHeader "content-disposition", "filename=Daftar karyawan Haria"& Request.QueryString("tgla") &" Sampai "& Request.QueryString("tgle") &".xls"
%>
...
<head>
    ...
    <title>DAFTAR KARYAWAN HARIAN</title>
