...
shift.commandText = "SELECT * FROM HRD_M_Shift WHERE SH_ID = '"& id &"'"
set update = shift.execute
 %> 
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="container mt-3">
    <div class="row">
        <div class="col-md">
            <h3 class="text-center">FORM UPDATE MASTER SHIFT</h3>
        </div>
    </div> 
    <div class='row mt-2'>
        <div class='col-md-12'>
            <form name="formShift" method="post" action="update_add.asp" onsubmit="return validasiShift()"> 
                <div class="row mb-3 justify-content-md-center">
                    <div class="col-2">
                        <label for="idshift" class="col-form-label">ID Shift</label>
                    </div>
                    <div class="col-sm-8"> 
                        <input type="text" id="idshift" name="idshift" class="form-control" aria-describedby="Inline" max="5" autocomplete="off" value="<%= update("SH_ID") %>" readonly>
                    </div>
                </div>
                <div class="mb-3 row justify-content-md-center">
                    ...
                    <div class="col-sm-8">
                        <input type="text" id="nama" name="nama" class="form-control" aria-describedby="Inline"  autocomplete="off" value="<%= update("SH_Name") %>" required>
                    </div>
                </div>
                <div class="mb-3 row justify-content-md-center">
                    <div class="col-2">
                    ...
                    <div class="col-sm-3">
                        <input type="number" id="jamIn" name="jamIn" class="form-control" aria-describedby="Inline" value="<%= update("SH_JamIn") %>" required>
                    </div>
                    <div class="col-sm-2">
                        <label for="minIn" class="col-form-label">Menit In</label>
                    </div>
                    <div class="col-sm-3">
                        <input type="number" id="minIn" name="minIn" class="form-control" aria-describedby="Inline" value="<%= update("SH_MEnitIn") %>" required>
                    </div>
                </div>
                <div class="mb-3 row justify-content-md-center">
                    <div class="col-2">
                    ...
                    <div class="col-sm-3">
                        <input type="number" id="jamOut" name="jamOut" class="form-control" aria-describedby="Inline" value="<%= update("SH_JamOut") %>" required>
                    </div>
                    <div class="col-sm-2">
                        <label for="minOut" class="col-form-label">Menit Out</label>
                    </div>
                    <div class="col-sm-3">
                        <input type="number" id="minOut" name="minOut" class="form-control" aria-describedby="Inline" value="<%= update("SH_MenitOut") %>" required>
                    </div>
                </div>
                <div class="mb-3 row">
                    ...
                    <div class="col-md-3">
                        <select class="form-select" aria-label="Default select example" name="bhari" id="bhari" required>
                            <option value="<%= update("SH_iHari") %>"><%= update("SH_iHari") %></option>
