...
<div class="container">
    ...
    <div class="upload">
        <form name="frmSend" method="POST" enctype="multipart/form-data" action="postSuratDokter.asp?nip=<%=request.querystring("nip")%>&id=<%=request.querystring("id")%>" onSubmit="return onSubmitForm(this);">   	<p style="margin-top: 0; margin-bottom: 0">&nbsp;</p>
        ...
        if Request.ServerVariables("REQUEST_METHOD") <> "POST" then
			...
			response.redirect "send_API_suratdokter.asp?nip=" & request.querystring("nip") & "&id=" & request.querystring("id")
        end if
        ...
        <img src="logo/berhasil_dakota.PNG">
    </div>
</div>
</body>
