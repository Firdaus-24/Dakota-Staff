        ...
        <div class='col'>
            <table class="table tablePembayaran">
                <thead>
                    ...
                    <%if session("HT1BB") = true OR session("HT1BC") = true OR session("HT1BD") = true then %>
                ...
                <tr>
                    ...
                    <td>
                      <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                        ...
                        <%end if%>
                        <%if session("HT1BC") = true then%>
                          <% if rs("TPK_AktifYN") = "Y" then %>
                            <button type="button" class="btn btn-danger btn-sm py-0 px-2" onclick="return aktifPembayaran('<%=rs("TPK_ID")%>','<%= rs("TPK_AktifYN") %>','<%= rs("TPK_Nip") %>')">NonAktif</button>
                          <% else %>
                            <button type="button" class="btn btn-warning btn-sm py-0 px-2" onclick="return aktifPembayaran('<%=rs("TPK_ID")%>','<%= rs("TPK_AktifYN") %>','<%= rs("TPK_Nip") %>')">Aktif</button>
                          <% end if %>
                        <% end if %>
                        <%if session("HT1BD") = true then%>
