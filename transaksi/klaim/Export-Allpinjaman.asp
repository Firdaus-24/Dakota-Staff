...
<%  
    ...
    Response.AddHeader "content-disposition", "filename=LAPORANPINJAMANKARYAWAN.xls"
    ...
    query = "SELECT HRD_M_Karyawan.Kry_Nama, HRD_M_Karyawan.Kry_Nip, HRD_T_PK.TPK_ID, HRD_T_PK.TPK_Tanggal, HRD_T_PK.TPK_Nip, HRD_T_PK.TPK_Ket, HRD_T_PK.TPK_PP, HRD_T_PK.TPK_Bunga, HRD_T_PK.TPK_Lama, HRD_T_PK.TPK_AktifYN FROM HRD_M_Karyawan LEFT OUTER JOIN HRD_T_PK ON HRD_M_karyawan.Kry_Nip = HRD_T_PK.TPK_Nip LEFT OUTER JOIN GLB_M_Agen ON HRD_M_Karyawan.Kry_AgenID = GLB_M_Agen.Agen_ID WHERE HRD_M_Karyawan.Kry_AktifYN = 'Y' AND HRD_T_PK.TPK_Ket NOT LIKE '%CICILAN ELEKTRONIK%' AND TPK_ID IS NOT NULL"
...
<body>
    <table style="font-size:14px;">
        ...
        <tr>
            <td style="font-size:10px;" colspan="9">Tanggal Cetak <%= (Now) %></td>
        </tr>
                    <tr>
                        <th scope="col">Nip</th>
