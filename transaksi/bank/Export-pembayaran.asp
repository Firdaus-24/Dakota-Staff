...
<% 
    ...
    cetak.commandText = "SELECT HRD_T_BK_Bank.*, HRD_M_Karyawan.Kry_Nama FROM HRD_T_BK_Bank LEFT OUTER JOIN HRD_M_Karyawan ON HRD_T_BK_Bank.TPK_Nip = HRD_M_Karyawan.Kry_Nip WHERE TPK_ID_Bank = '"& p &"'"
