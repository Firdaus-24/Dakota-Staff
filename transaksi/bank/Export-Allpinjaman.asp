...
<%  
    ...
    Response.AddHeader "content-disposition", "filename=LAPORANPINJAMANBANK.xls"
    ...
    query = "SELECT HRD_M_Karyawan.Kry_Nama, HRD_M_Karyawan.Kry_Nip, HRD_M_Jabatan.Jab_Nama,HRD_T_PK_Bank.TPK_ID_Bank, HRD_T_PK_Bank.TPK_Tanggal, HRD_T_PK_Bank.TPK_Nip, HRD_T_PK_Bank.TPK_Ket, HRD_T_PK_Bank.TPK_PP, HRD_T_PK_Bank.TPK_Bunga, HRD_T_PK_Bank.TPK_Lama, HRD_T_PK_Bank.TPK_AktifYN, GLB_M_Agen.Agen_Nama FROM HRD_M_Karyawan LEFT OUTER JOIN HRD_T_PK_Bank ON HRD_M_karyawan.Kry_Nip = HRD_T_PK_Bank.TPK_Nip LEFT OUTER JOIN GLB_M_Agen ON HRD_M_Karyawan.Kry_AgenID = GLB_M_Agen.Agen_ID LEFT OUTER JOIN HRD_M_Jabatan ON HRD_M_karyawan.Kry_JabCode = HRD_M_Jabatan.Jab_Code WHERE HRD_M_Karyawan.Kry_AktifYN = 'Y' AND TPK_ID_Bank IS NOT NULL"
...
<head>
    ...
    <title>EXPORT PINJAMAN BANK</title>
