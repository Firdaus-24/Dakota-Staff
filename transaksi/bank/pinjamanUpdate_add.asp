...
if not data.eof then
    update_cmd.commandText = "UPDATE HRD_T_PK_Bank SET TPK_Tanggal = '"& tgl &"', TPK_PP = '"& hutang &"', TPK_Bunga = '"& bunga &"', TPK_Lama = '"& lama &"', TPK_updateID = '"& id &"', TPK_UpdateTIme = '"& date() &"', TPK_PotongGajiYN = '"& potgaji &"' WHERE TPK_ID_Bank = '"& nomor &"'"
