...
<% 
    if session("HT4BD") = false then
        Response.Redirect("pembayaran.asp")
    end if

    ' Response.ContentType = "application/vnd.ms-excel"
    ' Response.AddHeader "content-disposition", "filename=:LAPORANPEMBAYARANPRIBADI.xls"
...
<head>
    ...
    <title>DAFTAR PEMBAYARAN CICILAN PRIBADI</title>
</head>
...
<body>
    <table style="white-space: nowrap;font-size:14px;">
        ...
        <% do until print.eof %>
            <tr>
                <th style="mso-number-format:\@;"><%= print("TPK_ID_Pribadi") %></th>
