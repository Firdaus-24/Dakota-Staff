...
<% 
    ...
    pinjaman.commandText = "SELECT HRD_T_PK_Pribadi.*, HRD_M_Karyawan.Kry_Nama, HRD_M_Jabatan.Jab_Nama, GLB_M_Agen.Agen_Nama FROM HRD_M_Karyawan LEFT OUTER JOIN HRD_T_PK_Pribadi ON HRD_M_Karyawan.Kry_Nip = HRD_T_PK_Pribadi.TPK_Nip LEFT OUTER JOIN HRD_M_Jabatan ON HRD_M_Karyawan.Kry_JabCode = HRD_M_Jabatan.Jab_Code LEFT OUTER JOIN GLB_M_agen ON HRD_M_Karyawan.Kry_AgenID = GLB_M_Agen.Agen_ID WHERE HRD_T_PK_Pribadi.TPK_ID_Pribadi = '"& p &"'"
...
<head>
    ...
    <title>LAPORAN PINJAMAN PRIBADI</title>
