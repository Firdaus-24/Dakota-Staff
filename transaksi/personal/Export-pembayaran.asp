...
<% 
    ...
    cetak.commandText = "SELECT HRD_T_BK_Pribadi.*, HRD_M_Karyawan.Kry_Nama FROM HRD_T_BK_Pribadi LEFT OUTER JOIN HRD_M_Karyawan ON HRD_T_BK_Pribadi.TPK_Nip = HRD_M_Karyawan.Kry_Nip WHERE TPK_ID_Pribadi = '"& p &"'"
...
<head>
    ...
    <title>PEMBAYARAN CICILAN BANK</title>
