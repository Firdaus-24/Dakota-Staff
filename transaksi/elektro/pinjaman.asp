    ...
    <div class="modal-content">
      ...
      <form action='pinjaman_add.asp' method='post' onsubmit="return validasiPinjaman()">
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-4">
            <input type="text" class="form-control form-control-sm" id="hutang" name='hutang' onchange="rupiah(this.value,'hutang')" autocomplate="off" required>
          </div>
        </div>
        <div class="row mb-3">
          <label for="bunga" class="col-sm-4 col-form-label col-form-label-sm">Total Bunga</label>
          <div class="col-sm-4">
            <input type="text" class="form-control form-control-sm" id="bunga" name='bunga' autocomplate="off" required>
          </div>
        ...
        <div class="row mb-3">
          ...
          <div class="col-sm-4">
            <input type="number" class="form-control form-control-sm" id="lama" name='lama' oninput="return hitungCicilan()" autocomplate="off" placeholder="Lama Pinjaman" required>
          </div>
          <div class="col-sm-4">
            <p>/Bulan</p>
          </div>
