...
<div class='container'>
    <div class='form-mutasi'>
        <div class='row mb-3'>
            <div class='col text-center'>
                <h3>LAPORAN PINJAMAN DAN PEMBAYARAN CICILAN BARANG ELEKTRONIK</h3>
            </div>
        </div>
        <form action="mutasi.asp" method="post" name="form-mutasi">
        <div class='row'>
        ...
        <div class='row mt-2'>
            ...
            <div class='col'>
                <div class="btn-group" role="group" aria-label="Basic example">
                    ...
                    <button type="button" class="btn btn-primary btn-sm" onclick="window.location.href='exportXls-MutasiBarang.asp?bulan=<%=bulan%>&tahun=<%=tahun%>&nama=<%=nama%>&radio=<%=radio%>'">Export</button>
                    <% end if %>
    ...
    <% if radio = "detail" then  %>
        <div class='row'>
            <div class='col text-center'>
                <label><b><u>PINJAMAN DAN PEMBAYARAN CICILAN BARANG DETAIL</u></b></label></br>
                <%if bulan <> "" then%>
    ...
    <div class='row'>
        <div class='row'>
            <div class='col text-center'>
                <label><b><u>LAPORAN PENGAMBILAN DAN PEMBAYARAN CICILAN REKAPITULASI</u></b></label></br>
                <%if bulan <> "" then%>
                    <label>Priode Bulan <%= MonthName(bulan) &" Tahun "& tahun%></label>
                <%else%>
                    <label>Priode Tahun <%= tahun%></label>
