...
<% 
    ...
    set shiftkaryawan_cmd = server.createObject("ADODB.Command")
    shiftkaryawan_cmd.activeConnection = MM_Cargo_string
    ...
    if bulana <> "" and bulane <> "" then
        ...
        shiftkaryawan_cmd.commandText = root
...
<div class="container">
    ...
    <div class="row text-center">
        <div class="col-lg">
            <h3 class="mt-3">PENCARIAN SHIFT</h3>
        </div>
    </div>
    <div class='row mb-3 mt-4'>
        <div class='col-sm-12 '>
            <form action="shiftkaryawan.asp" method="post">
                ...
                <div class="row text-center">
                    <div class="col-sm-12 mt-2">
                        <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-search" aria-hidden="true"></i> CARI</button>
                        <button type="button" class="btn btn-sm btn-danger" onclick="window.location.href='shift_view.asp'">Kembali</button>
                    </div>
                </div>
    ...
    <div class="row text-center">
        <div class="col-lg">
            <h3 class="mt-3">DAFTAR DIVISI SETTING SHIFT</h3>
        </div>
    </div>
    <button class="btn btn-primary" type="button" onclick="window.location.href=`shiftKaryawan.asp`"><i class="fa fa-coffee"></i> Refresh</button>
        <div class='row mt-3'>
            <div class='col-lg'>    
                <table class="table table-striped table-hover table-daftardivisi">
                    ...
                    <tr>
                        <td>
                            ...
                            <td>Aktif</td>
                        <td>
                            <a href="daftarkaryawanshift.asp?id=<%= rs("Div_Code") %>&bulana=<%= bulana %>&bulane=<%= bulane %>&cabang=<%= cabang %>"class="badge bg-info text-dark">Detail</a>
                        </td>
                    </tr>
                    <% 
