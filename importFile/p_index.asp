...
If Not objFSO.FileExists(Server.MapPath(sFileName)) Then  
	Response.Write "<div class='notiv-gagal' data-aos='fade-up'><span>FILE NOT FOUNT</span><img src='../logo/gagal_dakota.PNG'><a href='index.asp' class='btn btn-primary'>kembali</a></div>" 
Else  
    '*** Open Files ***'  
        ...
        if header >= 2 then 
            if not trim(arrRows(0)) = "" then  'cek kondisi jika packageID kosong tidak di input ke system
                ...
                if not cekPckID.eof then
                    ...
                    ' Response.write(expCsv_cmd.commandtext) & "<BR>"
                    expCsv_cmd.execute
