...
Response.AddHeader "Content-Disposition", "attachment; filename = ProfileKaryawan.doc"  
 %>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class='row'>
        ...
        <div class="row gx-5">
            <div class="col-2 image top-50"> 
                <a href="uploadfoto/index.asp?nip=<%= nip %>&id=<%= nip %>">
                    <img  id="image" style="width:150px;" src="../Foto/<%= trim(karyawan("Kry_NIP")) %>.JPG " onerror="image()"> 
                </a>
            </div>
            <div class="col-md-10">
                <div class="row">
                    <div class="col-sm-6">
                        <label>NIP</label>
                            <input type=text name="nip" class="form-control" id="nip" value="<%= karyawan("Kry_NIP") %>" >
                        <label>Nama</label>
                    ...
                    <div class="col-sm-6">
                        <div class="form-check form-check-inline">
                            <label class="mt-2 mb-1 d-flex flex-row">BPJS KES</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" <% if karyawan("Kry_BPJSKesYN") = "Y" then %>    checked <% else %>  <% end if %> >
                                    <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" <% if karyawan("Kry_BPJSKesYN") = "N" then %> checked <% else %>  <% end if %> >           
                        ...
                        <label class="mt-2 mb-1 d-flex flex-row">BPJS KET</label>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" <% if karyawan("Kry_BPJSYN") = "Y" then %>    checked <% else %>  <% end if %> >
                                    <label class="form-check-label" for="inlineCheckbox1">Yes</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="checkbox" id="inlineCheckbox2" <% if karyawan("Kry_BPJSYN") = "N" then %> checked <% else %>  <% end if %> >           
                                    <label class="form-check-label" for="inlineCheckbox2">No</label>
                                </div>
                        </div><br/>
        ...
        <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <label>Agama</label>
                            ...
                            <% else %>
                                <input type=text class="form-control" name="Agama" id="Agama" value="<%= karyawan("Agama_Nama") %>" >
                            <% end if %>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-8">
                        <label>Jenis Kelamin</label>
                            ...
                            <input type=text name="jk" class="form-control" id="jk" value="Pria" >
                            <%else %>
                                <input type=text name="jk" class="form-control" id="jk" value="Wanita" >
                            <%end if %> 
                    </div>
                    <div class="col-md-4">
                        <label>Status Sosial</label>
                            <% if karyawan("Kry_SttSosial") = 0 then %> 
                                <input type=text name="ssos" class="form-control" id="ssos" value="Belum Menikah" >
                            <% elseIf  karyawan("Kry_SttSosial") = 1 then %> 
                                <input type=text name="ssos" class="form-control" id="ssos" value="Menikah" >
                            <% else %>
                                <input type=text name="ssos" class="form-control" id="ssos" value="Janda / Duda" >
                            <% end if %>  
                    </div>
                </div>
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-6">
                        <label>Status Pegawai</label>
                            <input type=text name="spegawai" class="form-control" id="spegawai" <% if karyawan("Kry_SttKerja") = 0 then %> value="Borongan" <% elseif karyawan("Kry_SttKerja") = 1 then %> value="Harian" <% elseif karyawan("Kry_SttKerja") = 2 then %> value="Kontrak" <% elseif karyawan("Kry_SttKerja") = 3 then %> value="Magang" <% else %> value="Tetap" <% end if %> readonly> 
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <label>Divisi</label> 
                    <input type=text name="Divisi" class="form-control" id="Divisi" value="<%= karyawan("Div_Nama") %>" readonly>
                <div class="row">
                    <div class="col">
...
<script>
    // foto yang eror
    function image(){
      document.getElementById("image").src = "../Foto/NoPhotoAvailable.JPG ";
    }
</script>
    <!--content-->
