...
tambah.commandText = "UPDATE HRD_T_Mutasi SET Mut_ID = '"& id &"', Mut_Nip = '"& nip &"', Mut_Tanggal = '"& tgl &"', Mut_NoSurat = '"& nosurat &"', Mut_Memo = '"& memo &"', Mut_AsalAgenID = '"& cabang &"', Mut_AsalJabCode = '"& jabatan &"', Mut_AsalJJID = '"& jenjang &"', Mut_AsalDDBID = '"& divisi &"', Mut_TujAgenID = '"& cabang1 &"', Mut_TujJabCode = '"& jabatan1 &"', Mut_TujJJID = '"& jenjang1 &"', Mut_TujDDBID = '"& divisi1 &"' WHERE Mut_ID = '"& id &"'"
