...
<div class="container mt-2 mb-3 px-4 data-detail" style="border-radius:5px;">   
    <div class="row mt-3">
        <div class="col-md-2 image top-50"> 
            <a href="uploadfoto/index.asp?nip=<%= nip %>&id=<%= nip %>">
                <img  id="image" style="max-width:150px;" src="../Foto/<%= trim(karyawan("Kry_NIP")) %>.JPG " onerror="this.onerror=null;this.src='../Foto/NoPhotoAvailable.JPG';"> 
            </a>
        </div>
        <div class="col-md-10">
            <div class="row">
    ...
    <div class="row mt-3 p-2 ">  
        <div class="col-lg-3 mt-3 " >
            ...
            <% if session("HA1B") = true then %>
                <button type="button" class="btn btn-warning update-krywn" name="update-krywn" id="update-krywn" onclick="window.location='karyawanUpdate/index.asp?nip=<%=nip%>'">Update</button>
            <% end if %>
            <% if session("HA1C") = true then %>
                <button type="button" class="btn btn-success cetak-detail" name="cetak-detail" id="cetak-detail">Cetak</button>
            <% end if %>
        </div>
    </div>
